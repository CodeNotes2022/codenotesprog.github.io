          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option  value="/elab/courses?search=test&amp;type=" selected>Select type</option>
                  <option value="/elab/courses?search=test&amp;type=1" >Top Courses</option>
                  <option value="/elab/courses?search=test&amp;type=2" >Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                      <option value="/elab/courses?search=test&amp;value=" selected>All</option>
                      <option value="/elab/courses?search=test&amp;value=free" >Free</option>
                      <option value="/elab/courses?search=test&amp;value=premium" >Premium</option>
                    </select>
                  </div>
                ...
                <div class="action-widget__body">
                  <div class="action-widget__body">
                      <select class="select select-sm cat" onChange="window.location.href=this.value">
                          <option  value="/elab/courses?search=test&amp;category=" selected>All</option>
                                                    <option value="/elab/courses?search=test&amp;category=development" >Development</option>
                                                    <option value="/elab/courses?search=test&amp;category=it-software" >It &amp; Software</option>
                                                    <option value="/elab/courses?search=test&amp;category=html" >HTML</option>
                                                    <option value="/elab/courses?search=test&amp;category=css3" >CSS3</option>
                                                    <option value="/elab/courses?search=test&amp;category=python" >Python</option>
                                                    <option value="/elab/courses?search=test&amp;category=java" >Java</option>
                                                    <option value="/elab/courses?search=test&amp;category=c" >C#</option>
                                                    <option value="/elab/courses?search=test&amp;category=c" >C++</option>
                                                </select>
                    </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                        <option value="/elab/courses?search=test&amp;level=" selected>All</option>
                                                 <option value="/elab/courses?search=test&amp;level=beginner" >Beginner</option>
                                                 <option value="/elab/courses?search=test&amp;level=intermediate" >Certificate</option>
                                                 <option value="/elab/courses?search=test&amp;level=advance" >Advance</option>
                                                 <option value="/elab/courses?search=test&amp;level=4" >diploma</option>
                                                 <option value="/elab/courses?search=test&amp;level=5" >5</option>
                                            </select>
                  </div>
        ...
        <div class="col-lg-9">
          <form class="hero-search-form category-search-form mb-3" action="#" method="GET">
            ...
            <div class="course-card__thumb">
              <img src="assets/course/thumbnail/thumb_616475fbb81c01633973755.png" alt="image">
              <div class="course-type"><i class="las la-file-video"></i></div>
            </div>
            <div class="course-card__content">
              <span class="course-tag fs--12px">Basic Web</span>
              <h6 class="course-title mt-2"><a href="course/details/12-102-test.html">102 test</a></h6>
            ...
            <div class="course-footer">
              <div class="w-100 text-center">
                                ...
                                <a href="course/details/12-102-test.html" class="btn btn-sm btn--base w-100 mt-4">View Details</a>
              </div>
            </div>
          </div><!-- course-card end -->
                <div class="course-card list-view">
            <div class="course-card__thumb">
              <img src="assets/course/thumbnail/thumb_61b6ad61a2ddc1639361889.jpg" alt="image">
              <div class="course-type"><i class="las la-file-video"></i></div>
            </div>
            <div class="course-card__content">
              <span class="course-tag fs--12px">Basic Web</span>
              <h6 class="course-title mt-2"><a href="course/details/14-test.html">test</a></h6>
              <span class="badge bg--primary font-weight-normal mt-2">Advance</span>
              <div class="ratings d-flex align-items-center fs--14px mt-1">
                <i class="lar la-star"></i><i class="lar la-star"></i><i class="lar la-star"></i><i class="lar la-star"></i><i class="lar la-star"></i>                <span class="ms-2">(0)</span>
              </div>
              <div class="course-mentor mt-2">
            ...
            <div class="course-footer">
              <div class="w-100 text-center">
                                <div class="course-price"> Free </div>
                                <a href="course/details/14-test.html" class="btn btn-sm btn--base w-100 mt-4">View Details</a>
              </div>
            </div>
          </div><!-- course-card end -->
