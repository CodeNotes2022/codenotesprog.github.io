...
<!-- Mirrored from script.viserlab.com/elab/courses/basic-web by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Mar 2022 19:52:04 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title> E-Lab - Courses of Basic Web</title>
  <meta name="title" Content="E-Lab - Courses of Basic Web">
    ...
    <meta name="apple-mobile-web-app-title" content="E-Lab - Courses of Basic Web">
    
    <meta itemprop="name" content="E-Lab - Courses of Basic Web">
    ...
    <meta property="og:url" content="basic-web.html">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-6 text-center">
          <h2 class="page-title text-white">Courses of Basic Web</h2>
          <ul class="page-breadcrumb justify-content-center">
            <li><a href="https://script.viserlab.com/elab">Home</a></li>
            <li>Courses of Basic Web</li>
          </ul>
        </div>
      </div>
    </div>
          ...
          <div class="course-card">
            ...
            <div class="course-card__content">
              ...
              <div class="course-footer">
                ...
                <div class="right">
                  <div class="course-price text--base">$49.00</div>
                </div>
              </div>
            </div>
          </div><!-- course-card end -->
