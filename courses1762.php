          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option  value="/elab/courses?search=wnew&amp;type=" selected>Select type</option>
                  <option value="/elab/courses?search=wnew&amp;type=1" >Top Courses</option>
                  <option value="/elab/courses?search=wnew&amp;type=2" >Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                      <option value="/elab/courses?search=wnew&amp;value=" selected>All</option>
                      <option value="/elab/courses?search=wnew&amp;value=free" >Free</option>
                      <option value="/elab/courses?search=wnew&amp;value=premium" >Premium</option>
                    </select>
                  </div>
                ...
                <div class="action-widget__body">
                  <div class="action-widget__body">
                      <select class="select select-sm cat" onChange="window.location.href=this.value">
                          <option  value="/elab/courses?search=wnew&amp;category=" selected>All</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=development" >Development</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=it-software" >It &amp; Software</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=html" >HTML</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=css3" >CSS3</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=python" >Python</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=java" >Java</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=c" >C#</option>
                                                    <option value="/elab/courses?search=wnew&amp;category=c" >C++</option>
                                                </select>
                    </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                        <option value="/elab/courses?search=wnew&amp;level=" selected>All</option>
                                                 <option value="/elab/courses?search=wnew&amp;level=beginner" >Beginner</option>
                                                 <option value="/elab/courses?search=wnew&amp;level=intermediate" >Certificate</option>
                                                 <option value="/elab/courses?search=wnew&amp;level=advance" >Advance</option>
                                                 <option value="/elab/courses?search=wnew&amp;level=4" >diploma</option>
                                                 <option value="/elab/courses?search=wnew&amp;level=5" >5</option>
                                            </select>
                  </div>
