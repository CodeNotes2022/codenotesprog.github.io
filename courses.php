          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option  value="/elab/courses?type=" selected>Select type</option>
                  <option value="/elab/courses?type=1" >Top Courses</option>
                  <option value="/elab/courses?type=2" >Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                      <option value="/elab/courses?value=" selected>All</option>
                      <option value="/elab/courses?value=free" >Free</option>
                      <option value="/elab/courses?value=premium" >Premium</option>
                    </select>
                  </div>
                ...
                <div class="action-widget__body">
                  <div class="action-widget__body">
                      <select class="select select-sm cat" onChange="window.location.href=this.value">
                          <option  value="/elab/courses?category=" selected>All</option>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                        <option value="/elab/courses?level=" selected>All</option>
                                                 <option value="/elab/courses?level=beginner" >Beginner</option>
                                                 <option value="/elab/courses?level=intermediate" >Certificate</option>
                                                 <option value="/elab/courses?level=advance" >Advance</option>
                                                 <option value="/elab/courses?level=4" >diploma</option>
                                                 <option value="/elab/courses?level=5" >5</option>
                                            </select>
                  </div>
