          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option  value="/elab/courses?category=development&amp;type=" selected>Select type</option>
                  <option value="/elab/courses?category=development&amp;type=1" >Top Courses</option>
                  <option value="/elab/courses?category=development&amp;type=2" >Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                      <option value="/elab/courses?category=development&amp;value=" selected>All</option>
                      <option value="/elab/courses?category=development&amp;value=free" >Free</option>
                      <option value="/elab/courses?category=development&amp;value=premium" >Premium</option>
                    </select>
                  </div>
                  ...
                  <div class="action-widget__body">
                      <select class="select select-sm cat" onChange="window.location.href=this.value">
                          <option  value="/elab/courses\?category=" >All</option>
                                                    <option value="/elab/courses\?category=development" selected>Development</option>
                                                    <option value="/elab/courses\?category=it-software" >It &amp; Software</option>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                        <option value="/elab/courses?category=development&amp;level=" selected>All</option>
                                                 <option value="/elab/courses?category=development&amp;level=beginner" >Beginner</option>
                                                 <option value="/elab/courses?category=development&amp;level=intermediate" >Certificate</option>
                                                 <option value="/elab/courses?category=development&amp;level=advance" >Advance</option>
                                                 <option value="/elab/courses?category=development&amp;level=4" >diploma</option>
                                                 <option value="/elab/courses?category=development&amp;level=5" >5</option>
                                            </select>
                  </div>
