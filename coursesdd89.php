          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option  value="/elab/courses?search=javascript&amp;type=" selected>Select type</option>
                  <option value="/elab/courses?search=javascript&amp;type=1" >Top Courses</option>
                  <option value="/elab/courses?search=javascript&amp;type=2" >Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                      <option value="/elab/courses?search=javascript&amp;value=" selected>All</option>
                      <option value="/elab/courses?search=javascript&amp;value=free" >Free</option>
                      <option value="/elab/courses?search=javascript&amp;value=premium" >Premium</option>
                    </select>
                  </div>
                ...
                <div class="action-widget__body">
                  <div class="action-widget__body">
                      <select class="select select-sm cat" onChange="window.location.href=this.value">
                          <option  value="/elab/courses?search=javascript&amp;category=" selected>All</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=development" >Development</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=it-software" >It &amp; Software</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=html" >HTML</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=css3" >CSS3</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=python" >Python</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=java" >Java</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=c" >C#</option>
                                                    <option value="/elab/courses?search=javascript&amp;category=c" >C++</option>
                                                </select>
                    </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                    <select class="select select-sm" onChange="window.location.href=this.value">
                        <option value="/elab/courses?search=javascript&amp;level=" selected>All</option>
                                                 <option value="/elab/courses?search=javascript&amp;level=beginner" >Beginner</option>
                                                 <option value="/elab/courses?search=javascript&amp;level=intermediate" >Certificate</option>
                                                 <option value="/elab/courses?search=javascript&amp;level=advance" >Advance</option>
                                                 <option value="/elab/courses?search=javascript&amp;level=4" >diploma</option>
                                                 <option value="/elab/courses?search=javascript&amp;level=5" >5</option>
                                            </select>
                  </div>
          ...
          <form class="hero-search-form category-search-form mb-3" action="#" method="GET">
            ...
            <div class="course-footer">
              <div class="w-100 text-center">
                ...
                <div class="course-card list-view">
            <div class="course-card__thumb">
              <img src="assets/course/thumbnail/thumb_62110150c30001645281616.png" alt="image">
              <div class="course-type"><i class="las la-file-video"></i></div>
            </div>
            <div class="course-card__content">
              <span class="course-tag fs--12px">Graphics</span>
              <h6 class="course-title mt-2"><a href="course/details/15-javascript.html">Javascript</a></h6>
              <span class="badge bg--primary font-weight-normal mt-2">Beginner</span>
              <div class="ratings d-flex align-items-center fs--14px mt-1">
            ...
            <div class="course-footer">
              <div class="w-100 text-center">
                                <div class="course-price"> $6 </div>
                                <a href="course/details/15-javascript.html" class="btn btn-sm btn--base w-100 mt-4">View Details</a>
              </div>
            </div>
          </div><!-- course-card end -->
