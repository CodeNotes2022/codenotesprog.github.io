      ...
      <div class="row">
        ...
        <div class="col-lg-3 pe-4">
          ...
          <div class="action-sidebar">
            ...
            <div class="action-widget pt-0">
              ...
              <div class="action-widget__body">
                <select class="select select-sm" onChange="window.location.href=this.value">
                  <option value="/elab/courses?search=photoshop&amp;type=" selected>Select type</option>
                  <option value="/elab/courses?search=photoshop&amp;type=1">Top Courses</option>
                  <option value="/elab/courses?search=photoshop&amp;type=2">Latest Courses</option>
                </select>
              </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                  <select class="select select-sm" onChange="window.location.href=this.value">
                    <option value="/elab/courses?search=photoshop&amp;value=" selected>All</option>
                    <option value="/elab/courses?search=photoshop&amp;value=free">Free</option>
                    <option value="/elab/courses?search=photoshop&amp;value=premium">Premium</option>
                  </select>
                </div>
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                  <select class="select select-sm cat" onChange="window.location.href=this.value">
                    <option value="/elab/courses?search=photoshop&amp;category=" selected>All</option>
                    <option value="/elab/courses?search=photoshop&amp;category=development">Development</option>
                    <option value="/elab/courses?search=photoshop&amp;category=it-software">It &amp; Software</option>
                    <option value="/elab/courses?search=photoshop&amp;category=html">HTML</option>
                    <option value="/elab/courses?search=photoshop&amp;category=css3">CSS3</option>
                    <option value="/elab/courses?search=photoshop&amp;category=python">Python</option>
                    <option value="/elab/courses?search=photoshop&amp;category=java">Java</option>
                    <option value="/elab/courses?search=photoshop&amp;category=c">C#</option>
                    <option value="/elab/courses?search=photoshop&amp;category=c">C++</option>
                  </select>
                </div>
            ...
            <div class="action-widget">
              ...
              <div class="action-widget__body">
                <div class="action-widget__body">
                  <select class="select select-sm" onChange="window.location.href=this.value">
                    <option value="/elab/courses?search=photoshop&amp;level=" selected>All</option>
                    <option value="/elab/courses?search=photoshop&amp;level=beginner">Beginner</option>
                    <option value="/elab/courses?search=photoshop&amp;level=intermediate">Certificate</option>
                    <option value="/elab/courses?search=photoshop&amp;level=advance">Advance</option>
                    <option value="/elab/courses?search=photoshop&amp;level=4">diploma</option>
                    <option value="/elab/courses?search=photoshop&amp;level=5">5</option>
                  </select>
                </div>
          ...
          <div class="show-img mt-3 rounded-3 overflow-hidden d-lg-block d-none">
            <a class="advert d-block" data-advertid="11" target="_blank" href="https://google.com/"><img src="assets/images/advertisement/615c18f05c63a1633425648.jpg" alt="image" class="w-100"></a>
          </div>
          <div class="show-img mt-3 rounded-3 overflow-hidden d-lg-block d-none">
            <a class="advert d-block" data-advertid="11" target="_blank" href="https://google.com/"><img src="assets/images/advertisement/615c18f05c63a1633425648.jpg" alt="image" class="w-100"></a>
          </div>
          <div class="show-img mt-3 rounded-3 overflow-hidden d-lg-block d-none">
            <a class="advert d-block" data-advertid="10" target="_blank" href="https://google.com/"><img src="assets/images/advertisement/615c18ce67dee1633425614.jpg" alt="image" class="w-100"></a>
          </div>
        </div>
        <div class="col-lg-9">
